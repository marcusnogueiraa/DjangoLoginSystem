# Generated by Django 4.2.3 on 2023-08-15 03:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(related_name='post_comments', through='posts.Comment', to=settings.AUTH_USER_MODEL)),
